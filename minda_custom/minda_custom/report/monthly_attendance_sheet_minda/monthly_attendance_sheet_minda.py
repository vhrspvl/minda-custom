...
def execute(filters=None):
    ...
    for emp in sorted(att_map):
        ...
        row = [emp, emp_det.employee_name,emp_det.contractor, emp_det.branch, emp_det.department, emp_det.designation,
            emp_det.company]
...
def get_columns(filters):
    columns = [
        _("Employee") + ":Link/Employee:120", _("Employee Name") + "::140", _("Contractor") + "::140", _("Branch")+ ":Link/Branch:120",
...
def get_employee_details():
    ...
    for d in frappe.db.sql("""select name, contractor,employee_name, designation, department, branch, company,
